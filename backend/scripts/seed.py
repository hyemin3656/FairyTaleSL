...
BOOKS = _build_books() + [
    {
        ...
        "author": "전래동화",
        "sections": [
            {"order": 1, "title": "할아버지의 혹", "text": "얼굴에 큰 혹이 달린 할아버지가 있었습니다. 어느 날 숲 속에서 길을 잃었습니다.", "image_url": "/images/sections/혹부리_영감_1.jpg"},
            {"order": 2, "title": "도깨비 잔치", "text": "할아버지는 도깨비들의 잔치를 발견했습니다. 할아버지가 노래를 부르자 도깨비들이 좋아했습니다.", "image_url": "/images/sections/혹부리_영감_2.jpg"},
            {"order": 3, "title": "혹을 떼다", "text": "도깨비들은 노래의 비밀이 혹 속에 있다고 생각해 혹을 떼어 주었습니다. 할아버지는 기뻐하며 집으로 돌아갔습니다.", "image_url": "/images/sections/혹부리_영감_3.jpg"},
        ],
    },
    {
        "id": uuid.uuid4(),
        ...
        "author": "김은하",
        "sections": [
            {"order": 1, "title": "별똥별", "text": "소녀 하나는 밤하늘에서 반짝이는 별 하나가 사라진 것을 발견했습니다. 별을 찾아 우주 여행을 시작했습니다.", "image_url": "/images/sections/별을_찾아서_1.jpg"},
            {"order": 2, "title": "달나라", "text": "달에 도착한 하나는 달토끼를 만났습니다. 달토끼는 별이 블랙홀 근처에 있다고 알려 주었습니다.", "image_url": "/images/sections/별을_찾아서_2.jpg"},
            {"order": 3, "title": "별의 귀환", "text": "하나는 용기를 내어 블랙홀 근처로 날아갔습니다. 별을 찾아 하늘에 돌려보내자 온 우주가 환하게 빛났습니다.", "image_url": "/images/sections/별을_찾아서_3.jpg"},
        ],
    },
    {
        "id": uuid.uuid4(),
        ...
        "author": "전래동화",
        "sections": [
            {"order": 1, "title": "할머니의 팥죽", "text": "옛날에 혼자 사는 할머니가 있었습니다. 할머니는 팥죽을 끓이러 산에 팥을 따러 갔습니다. 그때 호랑이가 나타나 할머니를 잡아먹으려 했습니다.", "image_url": "/images/sections/팥죽할머니와_호랑이_1.jpg"},
            {"order": 2, "title": "친구들의 도움", "text": "할머니는 팥죽을 나눠 주겠다고 약속하며 위기를 넘겼습니다. 집에 돌아온 할머니는 팥죽을 끓였습니다. 알밤, 송곳, 맷돌, 지게, 소 등 친구들이 모여 호랑이를 기다렸습니다.", "image_url": "/images/sections/팥죽할머니와_호랑이_2.jpg"},
            {"order": 3, "title": "호랑이를 물리치다", "text": "밤에 호랑이가 나타났습니다. 알밤이 호랑이 눈을 때리고, 송곳이 발을 찌르고, 맷돌이 등을 눌렀습니다. 호랑이는 혼비백산 도망쳤습니다. 할머니는 친구들과 함께 팥죽을 맛있게 먹었습니다.", "image_url": "/images/sections/팥죽할머니와_호랑이_3.jpg"},
        ],
    },
    {
        "id": uuid.uuid4(),
        ...
        "author": "전래동화",
        "sections": [
            {"order": 1, "title": "하늘나라의 만남", "text": "하늘나라에 소를 모는 견우와 베를 짜는 직녀가 살았습니다. 둘은 서로 만나 사랑에 빠졌습니다. 그러나 사랑에 빠진 후 일을 게을리하여 하느님의 노여움을 샀습니다.", "image_url": "/images/sections/견우와_직녀_1.jpg"},
            {"order": 2, "title": "은하수의 이별", "text": "하느님은 두 사람을 은하수 양쪽으로 갈라놓았습니다. 견우와 직녀는 서로 바라보며 눈물을 흘렸습니다. 직녀의 눈물이 비가 되어 세상에 내렸습니다.", "image_url": "/images/sections/견우와_직녀_2.jpg"},
            {"order": 3, "title": "칠월 칠석의 만남", "text": "하느님은 일 년에 한 번, 칠월 칠석에만 만날 수 있도록 허락했습니다. 까치와 까마귀들이 날아와 다리를 놓아 주었습니다. 두 사람은 오작교 위에서 기쁘게 만났습니다.", "image_url": "/images/sections/견우와_직녀_3.jpg"},
        ],
    },
    {
        "id": uuid.uuid4(),
        ...
        "author": "전래동화",
        "sections": [
            {"order": 1, "title": "계모의 구박", "text": "옛날에 장화와 홍련이라는 두 자매가 살았습니다. 어머니가 돌아가신 뒤 계모가 들어왔습니다. 계모는 자매를 미워하며 심하게 구박했습니다.", "image_url": "/images/sections/장화홍련_1.jpg"},
            {"order": 2, "title": "억울한 죽음", "text": "계모는 장화에게 누명을 씌워 연못에 빠뜨렸습니다. 홍련도 언니를 따라 연못에 몸을 던졌습니다. 두 자매의 원혼은 매일 밤 부사 앞에 나타나 억울함을 호소했습니다.", "image_url": "/images/sections/장화홍련_2.jpg"},
